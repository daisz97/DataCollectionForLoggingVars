...
/**
 * 20210202/04
 * 构建用于GCN直接分类的数据，每一个代码段作为一个字符串，划分为train, val, test。
 * code var snippet存入codeVarSnippets.txt
 * 所有token对应的label放入tokensLabel.txt
 * 所有snippet的label(train,val,test)，放入snippetsLabel.txt
 * var是手动过滤的
 * 
 */
import java.util.*;
...
//			}
		...
		String codeVarSnippetPath = "D:\\Documents\\Program\\Eclipse\\dataHandleGCNData\\zookeeper\\gcnCodeVarSnippets.txt";
		String tokenLabelPath = "D:\\Documents\\Program\\Eclipse\\dataHandleGCNData\\zookeeper\\gcnTokensLabel.txt";
		String snippetLabelPath = "D:\\Documents\\Program\\Eclipse\\dataHandleGCNData\\zookeeper\\gcnSnippetsLabel.txt";
